"""
Setup.py files are important for packaging and distributing Python projects. It is used by setuptools to define the configuration of your project. They contain metadata, dependencies,etc about the project and instructions on how to install it.

Any python package that is installed or imported has its own setup file for its metadata, versions etc.

find_packages -> searches for folder having "__init__.py" file and considers them as packages. 
